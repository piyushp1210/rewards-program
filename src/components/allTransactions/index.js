        ...
        <Typography variant="h4" gutterBottom>
          All Transactions
            ...
            <div className={"dataTable"}>
                <DataGrid Background={"white"} autoHeight={true} rows={this.props.transactionData} columns={columns} initialState={{
                  sorting: {sortModel: [{ field: 'transactionDateTime', sort: 'desc' }]}}} />
            </div>
        </Box>
      </Paper>
    );
